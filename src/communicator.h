...
public:
    ...
    virtual int write(const void* local_buf, size_t len, uint64_t remote_addr, uint32_t rkey) = 0;
    virtual int read(void* local_buf, size_t len, uint64_t remote_addr, uint32_t rkey) = 0;
};
